...
CANONICAL_FIELDS: List[CanonicalField] = [
    ...
    CanonicalField("discount_rate", ["discount_rate", "discount", "discount_value", "discount_amount", "promo_discount"], required=False, dtype="float", description="Скидка в долях (0..1)"),
